...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4 text-center">Facebook Downloader</h1>
  </div>
</div>
 <section id="contact">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="alert alert-warning alert-dismissible fade show my-alert" role="alert">
              <strong>Result : </strong> <a href="" target="_blank"><span id="result"></span></a> 
            </div>
              <div class="mb-3">
                <label for="Name" class="form-label">URL</label>
<div class="popup-confirm">
<input type="text" id="fb" class="form-control" autocomplete="off">
</div>
