...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4 text-center">Hilih Font</h1>
  </div>
</div>
 <section id="contact">
      <div class="container">
...
<input type="text" id="hilih"class="form-control" autocomplete="off">
</div>
<div class="errorMsg"></div>
<br>
<button type="submit" class="btn btn-primary" onmousedown="buka.play()" onclick="checkId();">Submit</button>
</div>
</div>
    </section>
